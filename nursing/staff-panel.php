...
$allStaff = getData('staff');
$staff = array_filter($allStaff, function($s) {
...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .panel-card-badge{
    position:absolute; bottom:12px; left:12px; background:rgba(14,59,54,.88); color:#fff;
    padding:.35rem .85rem; border-radius:30px; font-size:.78rem; font-weight:700; backdrop-filter:blur(4px);
  }
  .panel-card-body{
  ...
  <div class="container d-flex justify-content-between align-items-center flex-wrap">
    ...
    <div class="d-flex gap-3 align-items-center">
      <?php if (isStaffLoggedIn()): ?>
        <a href="staff-dashboard.php" class="fw-bold text-warning"><i class="bi bi-speedometer2 me-1"></i> Staff Dashboard</a>
      <?php else: ?>
        <a href="staff-login.php" class="fw-bold"><i class="bi bi-person-lock me-1"></i> Staff Login</a>
        <a href="staff-register.php" class="fw-bold text-warning"><i class="bi bi-person-plus me-1"></i> Staff Self-Register</a>
      <?php endif; ?>
    </div>
  </div>
</div>
